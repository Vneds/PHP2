    ...
    <?php 
      ...
      <div class="col-md-12">
        <div class="tile">
          ...
          <div class="tile-body">
          <form class="row" method="POST" enctype="multipart/form-data" action="?page=/user&action=edit&id=<?php echo $user['ID']?>">
              ...
              <div class="form-group col-md-12">
                ...
                <div id="myfileupload">
                  <img src="../view/img/user/" alt="" style="width:300px">
                  <input type="file" id="uploadfile" name="img">
                </div>
                <div id="thumbbox">
                  <img height="450" width="400" alt="Thumb image" id="thumbimage" style="display: none" />
                  <a class="removeimg" href="javascript:">value=</a>
                </div>
                <div id="boxchoice">
