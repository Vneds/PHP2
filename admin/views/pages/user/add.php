...
<body class="app sidebar-mini rtl">
  ...
  <li><a class="app-menu__item active" href="?page=/user&action=list"><i class='app-menu__icon bx bx-id-card'></i> <span
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          ...
          <div class="tile-body">
          <form class="row" method="POST" enctype="multipart/form-data" action="?page=/user&action=add">
              ...
              <div class="form-group col-md-3">
                ...
                <input class="form-control" type="text" name="email" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" value="" required>
              ...
              <div class="form-group col-md-3">
                ...
                <input class="form-control" type="text" name="password" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" value="" required>
                <span class="text-danger"></span>
              </div>
              ...
              <a class="btn btn-cancel" href="?page=/user&action=list">Hủy bỏ</a>
            </div>
            </div>
          </form> 
  </main>
