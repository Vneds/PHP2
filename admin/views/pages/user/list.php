                    ...
                    <div class="tile-body">
                        ...
                        <div class="row element-button">
                            <div class="col-sm-2">
                              ...
                              <a class="btn btn-add btn-sm" href="?page=/user&action=add" title="Thêm"><i class="fas fa-plus"></i>
                                Tạo mới sản phẩm</a>
                            <!-- </div>
                             <div class="col-sm-2">
                                ...
                                <tr>
                                  ...
                                  <td><?php echo $role ?></td> 
                                    ...
                                    <td>
                                        ...
                                        <a href="?page=/user&action=delete&id=<?php echo $user['ID']?>"><button class="btn btn-primary btn-sm trash" type="submit" title="Xóa"
                                                 onclick="myFunction(this)"><i class="fas fa-trash-alt"></i>
                                             </button></a>
                                       
                                        <a href="?page=/user&action=edit&id=<?php echo $user['ID']?>"><button class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp" data-toggle="modal"
