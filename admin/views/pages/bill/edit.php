...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <li><a class="app-menu__item active" href="?page=/bill&action=list"><i class='app-menu__icon bx bx-task'></i><span
                    ...
                    <div class="tile-body">
                        ...
                        <div class="flex">
                            ...
                            <?php 
                              [$bill, $books] = $data;
                              $disabled = '';
                              if ($bill['status'] == 'Hoàn tất' || $bill['status'] == 'Đã hủy') {
                                  $disabled = 'disabled';
                              }
                            ?>

                              <form action="?page=/bill&action=edit&id=<?php echo $_GET['id'];?>" method='POST'>
                                ...
                                <select name="status" class="select" id=<?php echo $_GET['id']?> <?php echo $disabled?>>
                                  <option value=<?php echo $bill['status']?>><?php echo $bill['status']?></option>
                                    <?php
                                        $status_list = ['Đang xử lý', 'Hoàn tất', 'Đã hủy'];
                                          for ($i = 0 ; $i < count($status_list) ; $i++) {
                                            if ($bill['status'] == $status_list[$i]) {
                                              continue;
                                      }
                                    ?>
                            ...
                            <?php 
                                foreach($books as $book){
                                  $sum = (int)$book['quantity'] * (int)$book['book_price']; 
                              ?>                                                   
                                <tr>
                                    <td width="10"><input type="checkbox" name="check1" value="<?php echo $book['ID'] ?>"></td>
                                    <td>83216006</td>
                                    <td><?php echo $book['book_name'] ?></td>
                                    <td><img src="../<?php echo $book['thumnail'] ?>" alt="" width="100px;"></td>
                                    <td><?php echo $catergory_name?></td>
                                     <td><span class=""><?php echo $book['quantity'] ?></span></td>
