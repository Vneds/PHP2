    ...
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          ...
          <div class="tile-body">
          <form class="row" method="POST" enctype="multipart/form-data"  action="?page=/catergory&action=add">
              ...
              <a class="btn btn-cancel" href="?page=/catergory&action=list">Hủy bỏ</a>
            </div>
            </div>
          </form> 
  </main>
