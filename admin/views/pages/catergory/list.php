...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <li><a class="app-menu__item active" href="?page=/catergory&action=list"><i class='app-menu__icon bx bx-user-voice'></i><span
        class="app-menu__label">Quản lý danh mục</span></a></li>
  <li><a class="app-menu__item" href="?page=/product&action=list"><i
                    ...
                    <div class="tile-body">
                        <div class="row element-button">
                            <div class="col-sm-2">
                              ...
                              <a class="btn btn-add btn-sm" href="?page=/catergory&action=add" title="Thêm"><i class="fas fa-plus"></i>
                                Thêm danh mục</a>
                            </div>
                          </div>
                        ...
                        ?>
                            ...
                            ?>                                                    
                                <tr>
                                    ...
                                    <td><?php echo $catergory['ID']?></td>
                                    <td><?php echo $catergory['catergory_name']?></td>
                                    <td>
                                      
                                        <input type="text" value="" name="id" hidden>
                                        <input type="text" value="delete" name="action"hidden>
                                        <a href="?page=/catergory&action=delete&id=<?php echo $catergory['ID']?>"><button class="btn btn-primary btn-sm trash" type="submit" title="Xóa"
                                                 onclick="myFunction(this)"><i class="fas fa-trash-alt"></i>
                                             </button></a>
                                        </form>
                                        <a href="?page=/catergory&action=edit&id=<?php echo $catergory['ID']?>"><button class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp" data-toggle="modal"
