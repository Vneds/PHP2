  ...
  <main class="app-content">
    <div class="app-title">
      <ul class="app-breadcrumb breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Chỉnh sửa danh mục</a></li>
      </ul>
    </div>
    <?php 
          $catergory = $data;
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          ...
          <div class="tile-body">
          <form class="row" method="POST" enctype="multipart/form-data" action="?page=/catergory&action=edit&id=<?php echo $catergory['ID']?>">
              <input type="text" name="action" value="edit" hidden>
              <input type="text" name="id" value="" hidden>
              <div class="form-group col-md-3">
                <label class="control-label">Tên danh mục</label>
                <input class="form-control" type="text" name="catergory_name" required value="<?php echo $catergory['catergory_name'] ?>">
              </div>
