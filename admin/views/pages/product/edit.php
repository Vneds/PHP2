    ...
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          ...
          <div class="tile-body">
          <form class="row" method="POST" enctype="multipart/form-data" action="?page=/product&action=edit&id=<?php echo $_GET['id']?>">
              <input type="text" name="action" value="edit" hidden>
              <input type="text" name="id" value="<?php echo $product['id']?>" hidden>
              <div class="form-group col-md-3">
                <label class="control-label">Tên sản phẩm</label>
                <input required class="form-control" type="text" name="book_name" value="">
              </div>
              <!-- <div class="form-group  col-md-3">
              ...
              <div class="form-group col-md-3">
                ...
                <input required class="form-control" type="text"  name="book_price" value="">
                <span class="text-danger"></span>
              </div>
              <div class="form-group col-md-3">
                <label class="control-label">Hàng tồn</label>
                <input required class="form-control" type="text" name="stock" value="">
                <span class="text-danger"></span>
              </div>
              ...
              <a class="btn btn-cancel" href="?page=/product&action=list">Hủy bỏ</a>
            </div>
            </div>
          </form> 
  </main>
