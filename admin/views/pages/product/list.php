...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <hr>
    <ul class="app-menu">
    <li><a class="app-menu__item " href="?page=/"><i class='app-menu__icon bx bx-tachometer'></i><span
        class="app-menu__label">Bảng điều khiển</span></a></li>
  <li><a class="app-menu__item " href="?page=/user&action=list"><i class='app-menu__icon bx bx-id-card'></i> <span
  ...
  <li><a class="app-menu__item" href="?page=/catergory&action=list"><i class='app-menu__icon bx bx-user-voice'></i><span
        class="app-menu__label">Quản lý danh mục</span></a></li>
  <li><a class="app-menu__item active" href="?page=/product&action=list"><i
        class='app-menu__icon bx bx-purchase-tag-alt'></i><span class="app-menu__label">Quản lý sản phẩm</span></a>
  </li>
  <li><a class="app-menu__item" href="?page=/bill&action=list"><i class='app-menu__icon bx bx-task'></i><span
                ...
                <div class="tile">
                    <div class="tile-body">
                        <div class="row element-button">
                            <div class="col-sm-2">
                              <a class="btn btn-add btn-sm" href="?page=/product&action=add" title="Thêm"><i class="fas fa-plus"></i>
                                Tạo mới sản phẩm</a>
                            </div>
                            <?php 
                              $books = $data;
                        ...
                        <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            ?>                                                      
                                <tr>
                                    <td width="10"><input type="checkbox" name="check1" value="<td><?php echo $book['ID']?></td>"></td>
                                    <td>83216006</td>
                                    <td><?php echo $book['book_name']?></td>
                                    <td><img src="../img/product/<?php echo $book['thumnail']?>" alt="" width="100px;"></td>
                                    ...
                                    <td>
                                        ...
                                        <a href="?page=/product&action=delete&id=<?php echo $book['ID']?>"><button class="btn btn-primary btn-sm trash" type="submit" title="Xóa"
                                                 onclick="myFunction(this)"><i class="fas fa-trash-alt"></i>
                                             </button></a>
                                        </form>
                                        <a href="?page=/product&action=edit&id=<?php echo $book['ID']?>"><button class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp" data-toggle="modal"
