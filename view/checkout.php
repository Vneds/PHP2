    ...
    <section class="checkout spad">
        <div class="container">
            ...
            <div class="checkout__form">
                ...
                <form method="post" action="?page=/bill_model">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <?php 
                                    ...
                                    $total_money += $product['book_price'] * $product['quantity'];
                                    $sum += $total_money;
                                ?>
                                <ul>
                                    <li><?php echo $product['book_name']?><span>$<?php echo $product['book_price']?></span></li>
                                </ul>
