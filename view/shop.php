                ...
                <div class="col-lg-3 col-md-5">
                    <div class="sidebar">
                        <div class="sidebar__item">
                            <h4>Department</h4>
                            <ul>
                            <?php [$product_list,$catergory_list] = $data;
                                foreach($catergory_list as $catergory){

                            ?>
                                <li onclick="filter(this)" value=<?php echo $catergory['ID']?> ><a href="#"><?php echo $catergory['catergory_name']?></a></li>
                            <?php }?>
                            </ul>
                        </div>
                        <div class="sidebar__item">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="img/product/<?php echo $product['thumnail']?>">
                                    <ul class="product__item__pic__hover">
                                        <li><a href=""><i class="fa fa-heart"></i></a></li>
                                        <li><a href="?page=/details&id=<?php echo $product['ID']?>"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                    </ul>
                                </div>
                                <div class="product__item__text">
                                    <h6><a href="?/details?page=/detail&id=<?php echo $product['ID']?>"><?php echo $product['book_name']?></a></h6>
                                    <h5><?php echo $product['book_price'] ?></h5>
                                </div>
                            </div>
                        </div>
                        <?php } ?>
            ...
            $.ajax({
                ...
                success: function(result){
                    ...
                    result.forEach(product => {
                        html += `
                                    <div class="product__item">
                                        <div class="product__item__pic set-bg" data-setbg="img/product/${product['image_path']}">
                                            <ul class="product__item__pic__hover">
                                                <li><a href=""><i class="fa fa-heart"></i></a></li>
                                                <li><a href="?/details?page=detail&id=${product['id']}"><i class="fa fa-retweet"></i></a></li>
                                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                            </ul>
                                        </div>
                                        <div class="product__item__text">
                                            <h6><a href="?/details?page=detail&id=${product['id']}">${product['product_name']}</a></h6>
